...
//  echo "<p>Emblem array slot: ", $characterArraySlot;
...
<!--LFG POST STARTS HERE-->
    <div class="postContainer">
        <div class="postContent mdl-card mdl-card--primary mdl-shadow--2dp ">
            ...
            <div class="mdl-spinner mdl-spinner--single-color mdl-js-spinner is-active getStatsLoading" id="statsLoading"></div>
                <!--<div class="innerContainer">-->
                    <form id="playerStatsForm"> 
                        <input type="hidden" name="getStatsButton" value="<?= $displayName; ?>">
                            <button id="getStats" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Get Player Stats</button>
                        </input>
                    </form>
                <!--</div>    -->
        </div>
          ...
          $("#playerStatsForm").on("submit", function(e){
              ...
              .done(function(data){
                ...
                if(data.length > 0){
                    ...
                    var averageLifespan = test.Response.trialsOfOsiris.allTime.averageLifespan.basic.displayValue;
                    var winLossRatio = test.Response.trialsOfOsiris.allTime.winLossRatio.basic.displayValue;
